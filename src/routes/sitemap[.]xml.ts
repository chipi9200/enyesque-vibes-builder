    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/menu-del-dia", changefreq: "daily", priority: "0.9" },
          { path: "/galeria", changefreq: "monthly", priority: "0.6" },
          { path: "/opiniones", changefreq: "monthly", priority: "0.6" },
          { path: "/contacto", changefreq: "monthly", priority: "0.8" },
          { path: "/legal/aviso-legal", changefreq: "monthly", priority: "0.2" },
          { path: "/legal/privacidad", changefreq: "monthly", priority: "0.2" },
